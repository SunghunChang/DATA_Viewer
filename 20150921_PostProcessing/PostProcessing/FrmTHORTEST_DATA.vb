...
Public Class FrmTHORTEST_DATA
    ...
    Public Sub New()
        ...
        With Me
            ...
            TGraphCollection.Add(.Chart48)
            TGraphCollection.Add(.Chart49)
            TGraphCollection.Add(.Chart50)
            TGraphCollection.Add(.Chart51)
            TGraphCollection.Add(.Chart52)
            TGraphCollection.Add(.Chart53)
            TGraphCollection.Add(.Chart54)
            TGraphCollection.Add(.Chart55)
            TGraphCollection.Add(.Chart56)
            TGraphCollection.Add(.Chart57)
            TGraphCollection.Add(.Chart58)
            TGraphCollection.Add(.Chart59)
            TGraphCollection.Add(.Chart60)
            TGraphCollection.Add(.Chart61)
            TGraphCollection.Add(.Chart62)
            TGraphCollection.Add(.Chart63)
            ...
            CopyGraphCollection.Add(.Chart48)
            CopyGraphCollection.Add(.Chart49)
            CopyGraphCollection.Add(.Chart50)
            CopyGraphCollection.Add(.Chart51)
            CopyGraphCollection.Add(.Chart52)
            CopyGraphCollection.Add(.Chart53)
            CopyGraphCollection.Add(.Chart54)
            CopyGraphCollection.Add(.Chart55)
            CopyGraphCollection.Add(.Chart56)
            CopyGraphCollection.Add(.Chart57)
            CopyGraphCollection.Add(.Chart58)
            CopyGraphCollection.Add(.Chart59)
            CopyGraphCollection.Add(.Chart60)
            CopyGraphCollection.Add(.Chart61)
            CopyGraphCollection.Add(.Chart62)
            CopyGraphCollection.Add(.Chart63)
        End With

        For i = 1 To 48
            '차트 Title을 추가한다.
            '데이터를 그릴때 추가하면 계속 추가한다.
            AddTitles(TGraphCollection.Item(i), GraphTitle_THOR(i - 1))
        Next
        ...
        For i = 0 To UBound(Me.OpenTESTDlg.FileNames)
            If Mid(Me.OpenTESTDlg.SafeFileNames(i), Len(Me.OpenTESTDlg.SafeFileNames(i)) - 3, Len(Me.OpenTESTDlg.SafeFileNames(i))) = ".tdm" Or _
                Mid(Me.OpenTESTDlg.SafeFileNames(i), Len(Me.OpenTESTDlg.SafeFileNames(i)) - 3, Len(Me.OpenTESTDlg.SafeFileNames(i))) = ".TDM" Then
                IsTDMfile(i) = True
            End If
    ...
    Private Sub AddBtn_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles AddBtn.Click
        ...
        For i = Me.FileListBox.Items.Count To Tmp_Cnt + UBound(Me.OpenTESTDlg.FileNames)
            ...
            If Mid(Me.OpenTESTDlg.SafeFileNames(i - Tmp_Cnt), Len(Me.OpenTESTDlg.SafeFileNames(i - Tmp_Cnt)) - 3, Len(Me.OpenTESTDlg.SafeFileNames(i - Tmp_Cnt))) = ".tdm" OrElse _
                Mid(Me.OpenTESTDlg.SafeFileNames(i - Tmp_Cnt), Len(Me.OpenTESTDlg.SafeFileNames(i - Tmp_Cnt)) - 3, Len(Me.OpenTESTDlg.SafeFileNames(i - Tmp_Cnt))) = ".TDM" Then
                IsTDMfile(i) = True
            End If
            DATAFilePathList(i) = FilePathGet(Me.OpenTESTDlg.FileNames)
        Next
    ...
    Private Sub FrmTEST_DATA_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If TempLicExpire = False Then
            ...
            Try
                Using NewfileNum As StreamWriter = File.AppendText(RemoteValFolder & System.Environment.UserName)
                    NewfileNum.WriteLine("## TEST Data Display Form Open [THOR] : " & Date.Now.ToString & " ##")
                    NewfileNum.Close()
                End Using
        ...
        With Me
            ...
            .GraphTab.TabPages(2).Text = "TEST DATA #3"
    ...
    Private Sub ChList_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ChList.SelectedIndexChanged
        ...
        Else
            If InStr(Me.FileListBox.Items((Me.FileListBox.SelectedIndex)), ".tdm") > 1 Then
                FileNameR64 = Replace(Me.FileListBox.Items((Me.FileListBox.SelectedIndex)), ".tdm", "")
            ElseIf InStr(Me.FileListBox.Items((Me.FileListBox.SelectedIndex)), ".TDM") > 1 Then
                FileNameR64 = Replace(Me.FileListBox.Items((Me.FileListBox.SelectedIndex)), ".TDM", "")
            End If
    ...
    Private Sub FrmTEST_DATA_Resize(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Resize
        ...
        With Me
            ...
            .Chart48.Location = .Chart00.Location
            .Chart49.Location = .Chart01.Location
            .Chart50.Location = .Chart02.Location
            .Chart51.Location = .Chart03.Location
            .Chart52.Location = .Chart04.Location
            .Chart53.Location = .Chart05.Location
            .Chart54.Location = .Chart06.Location
            .Chart55.Location = .Chart07.Location
            .Chart56.Location = .Chart08.Location
            .Chart57.Location = .Chart09.Location
            .Chart58.Location = .Chart10.Location
            .Chart59.Location = .Chart11.Location
            .Chart60.Location = .Chart12.Location
            .Chart61.Location = .Chart13.Location
            .Chart62.Location = .Chart14.Location
            .Chart63.Location = .Chart15.Location
    ...
    Private Sub BtnApply_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnApply.Click
        ...
        Select Case Me.DummyCmb.SelectedIndex
            Case 0
                ReDim FindDummy(UBound(TEST_DRV_Para_THOR))
                FindDummy = TEST_DRV_Para_THOR
                DummyDisplayLegends = " - DRV"
            Case 1
                ReDim FindDummy(UBound(TEST_PAS_Para_THOR))
                FindDummy = TEST_PAS_Para_THOR
                DummyDisplayLegends = " - PAS"
            Case 2
                ReDim FindDummy(UBound(TEST_Etc_Para_THOR))
                FindDummy = TEST_Etc_Para_THOR
                ...
                For i = 0 To Me.ChList.Items.Count - 1
                    If InStr(Me.ChList.Items(i), Tmp_Char(LBound(Tmp_Char))) >= 1 Then
                        ...
                        For j = 0 To UBound(Tmp_Char)
                            If (UCase(Tmp_Char(j)) = "TIME") And (UCase(Me.ChList.Items(i))) <> "TIME" Then
        ...
        With Me
            ...
            Else
                ...
                If InStr(.FileListBox.Items((.FileListBox.SelectedIndex)), ".TDM") >= 1 Then
                    Tmp_File_Name = DATAFilePathList(.FileListBox.SelectedIndex) & Replace(.FileListBox.Items((.FileListBox.SelectedIndex)), ".TDM", ".tdx")
                Else
                    Tmp_File_Name = DATAFilePathList(.FileListBox.SelectedIndex) & Replace(.FileListBox.Items((.FileListBox.SelectedIndex)), ".tdm", ".tdx")
                End If
                Dim R64File As New FileInfo(Tmp_File_Name)
                Dim NumByte As Long = R64File.Length
                Dim Fstream As New FileStream(Tmp_File_Name, FileMode.Open, FileAccess.Read)
                Dim FileRead As New BinaryReader(Fstream)
                'Byte Array를 읽어온다.
                Values = FileRead.ReadBytes(CInt(NumByte))
            ...
            For i = 0 To 47  '그래프 개수
                ...
                If TEST_Para_Num(i, 0) <> -1 And TEST_Para_Num(i, 1) <> -1 Then
                    ...
                    '데이터를 그리기위한 함수 호출
                    If IsTDMfile(.FileListBox.SelectedIndex) = False Then
                        DrawingTESTgraphs(TGraphCollection.Item(i + 1), Tmp_X_Vals, Tmp_Y_Vals, .FileListBox.Items((.FileListBox.SelectedIndex)) & DummyDisplayLegends, GraphTitle_THOR(i))
                    Else
                        DrawingTESTgraphs(TGraphCollection.Item(i + 1), Tmp_X_Vals, Tmp_Y_Vals, .FileListBox.Items((.FileListBox.SelectedIndex)) & DummyDisplayLegends & ":" & _
                                          Me.TDMCHSel.Items(Me.TDMCHSel.SelectedIndex), GraphTitle_THOR(i))
                    End If
                ...
                Else
                    ...
                    ZeroDATA(TGraphCollection.Item(i + 1), Zero_Arr, Zero_Arr, .FileListBox.Items((.FileListBox.SelectedIndex)) & DummyDisplayLegends, GraphTitle_THOR(i))
                End If
    ...
    Private Sub Chart32_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles Chart32.DoubleClick
        Dim PopUpForm As New InjuryPopUp(48, Me.Chart32, 1)
        PopUpForm.Owner = Me
        PopUpForm.Show()
    End Sub
    Private Sub Chart33_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles Chart33.DoubleClick
        Dim PopUpForm As New InjuryPopUp(48, Me.Chart33, 1)
        PopUpForm.Owner = Me
        PopUpForm.Show()
    End Sub
    Private Sub Chart34_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles Chart34.DoubleClick
        Dim PopUpForm As New InjuryPopUp(48, Me.Chart34, 1)
        PopUpForm.Owner = Me
        PopUpForm.Show()
    End Sub
    Private Sub Chart35_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles Chart35.DoubleClick
        Dim PopUpForm As New InjuryPopUp(48, Me.Chart35, 1)
        PopUpForm.Owner = Me
        PopUpForm.Show()
    End Sub
    Private Sub Chart36_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles Chart36.DoubleClick
        Dim PopUpForm As New InjuryPopUp(48, Me.Chart36, 1)
        PopUpForm.Owner = Me
        PopUpForm.Show()
    End Sub
    Private Sub Chart37_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles Chart37.DoubleClick
        Dim PopUpForm As New InjuryPopUp(48, Me.Chart37, 1)
        PopUpForm.Owner = Me
        PopUpForm.Show()
    End Sub
    Private Sub Chart38_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles Chart38.DoubleClick
        Dim PopUpForm As New InjuryPopUp(48, Me.Chart38, 1)
        PopUpForm.Owner = Me
        PopUpForm.Show()
    End Sub
    Private Sub Chart39_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles Chart39.DoubleClick
        Dim PopUpForm As New InjuryPopUp(48, Me.Chart39, 1)
        PopUpForm.Owner = Me
        PopUpForm.Show()
    End Sub
    Private Sub Chart40_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles Chart40.DoubleClick
        Dim PopUpForm As New InjuryPopUp(48, Me.Chart40, 1)
        PopUpForm.Owner = Me
        PopUpForm.Show()
    End Sub
    Private Sub Chart41_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles Chart41.DoubleClick
        Dim PopUpForm As New InjuryPopUp(48, Me.Chart41, 1)
        PopUpForm.Owner = Me
        PopUpForm.Show()
    End Sub
    Private Sub Chart42_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles Chart42.DoubleClick
        Dim PopUpForm As New InjuryPopUp(48, Me.Chart42, 1)
        PopUpForm.Owner = Me
        PopUpForm.Show()
    End Sub
    Private Sub Chart43_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles Chart43.DoubleClick
        Dim PopUpForm As New InjuryPopUp(48, Me.Chart43, 1)
        PopUpForm.Owner = Me
        PopUpForm.Show()
    End Sub
    Private Sub Chart44_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles Chart44.DoubleClick
        Dim PopUpForm As New InjuryPopUp(48, Me.Chart44, 1)
        PopUpForm.Owner = Me
        PopUpForm.Show()
    End Sub
    Private Sub Chart45_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles Chart45.DoubleClick
        Dim PopUpForm As New InjuryPopUp(48, Me.Chart45, 1)
        PopUpForm.Owner = Me
        PopUpForm.Show()
    End Sub
    Private Sub Chart46_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles Chart46.DoubleClick
        Dim PopUpForm As New InjuryPopUp(48, Me.Chart46, 1)
        PopUpForm.Owner = Me
        PopUpForm.Show()
    End Sub
    Private Sub Chart47_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles Chart47.DoubleClick
        Dim PopUpForm As New InjuryPopUp(48, Me.Chart47, 1)
        PopUpForm.Owner = Me
        PopUpForm.Show()
    End Sub
    Private Sub Chart48_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles Chart48.DoubleClick
        Dim PopUpForm As New InjuryPopUp(32, Me.Chart48, 1)
        PopUpForm.Owner = Me
        PopUpForm.Show()
    End Sub
    Private Sub Chart49_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles Chart49.DoubleClick
        Dim PopUpForm As New InjuryPopUp(33, Me.Chart49, 1)
        PopUpForm.Owner = Me
        PopUpForm.Show()
    End Sub
    Private Sub Chart50_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles Chart50.DoubleClick
        Dim PopUpForm As New InjuryPopUp(34, Me.Chart50, 1)
        PopUpForm.Owner = Me
        PopUpForm.Show()
    End Sub
    Private Sub Chart51_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles Chart51.DoubleClick
        Dim PopUpForm As New InjuryPopUp(35, Me.Chart51, 1)
        PopUpForm.Owner = Me
        PopUpForm.Show()
    End Sub
    Private Sub Chart52_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles Chart52.DoubleClick
        Dim PopUpForm As New InjuryPopUp(36, Me.Chart52, 1)
        PopUpForm.Owner = Me
        PopUpForm.Show()
    End Sub
    Private Sub Chart53_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles Chart53.DoubleClick
        Dim PopUpForm As New InjuryPopUp(37, Me.Chart53, 1)
        PopUpForm.Owner = Me
        PopUpForm.Show()
    End Sub
    Private Sub Chart54_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles Chart54.DoubleClick
        Dim PopUpForm As New InjuryPopUp(38, Me.Chart54, 1)
        PopUpForm.Owner = Me
        PopUpForm.Show()
    End Sub
    Private Sub Chart55_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles Chart55.DoubleClick
        Dim PopUpForm As New InjuryPopUp(39, Me.Chart55, 1)
        PopUpForm.Owner = Me
        PopUpForm.Show()
    End Sub
    Private Sub Chart56_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles Chart56.DoubleClick
        Dim PopUpForm As New InjuryPopUp(40, Me.Chart56, 1)
        PopUpForm.Owner = Me
        PopUpForm.Show()
    End Sub
    Private Sub Chart57_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles Chart57.DoubleClick
        Dim PopUpForm As New InjuryPopUp(41, Me.Chart57, 1)
        PopUpForm.Owner = Me
        PopUpForm.Show()
    End Sub
    Private Sub Chart58_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles Chart58.DoubleClick
        Dim PopUpForm As New InjuryPopUp(42, Me.Chart58, 1)
        PopUpForm.Owner = Me
        PopUpForm.Show()
    End Sub
    Private Sub Chart59_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles Chart59.DoubleClick
        Dim PopUpForm As New InjuryPopUp(43, Me.Chart59, 1)
        PopUpForm.Owner = Me
        PopUpForm.Show()
    End Sub
    Private Sub Chart60_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles Chart60.DoubleClick
        Dim PopUpForm As New InjuryPopUp(44, Me.Chart60, 1)
        PopUpForm.Owner = Me
        PopUpForm.Show()
    End Sub
    Private Sub Chart61_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles Chart61.DoubleClick
        Dim PopUpForm As New InjuryPopUp(45, Me.Chart61, 1)
        PopUpForm.Owner = Me
        PopUpForm.Show()
    End Sub
    Private Sub Chart62_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles Chart62.DoubleClick
        Dim PopUpForm As New InjuryPopUp(46, Me.Chart62, 1)
        PopUpForm.Owner = Me
        PopUpForm.Show()
    End Sub
    Private Sub Chart63_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles Chart63.DoubleClick
        Dim PopUpForm As New InjuryPopUp(47, Me.Chart63, 1)
        PopUpForm.Owner = Me
        PopUpForm.Show()
    End Sub
    ...
    Private Sub TopToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TopToolStripMenuItem.Click
        Dim i As Integer
        For i = 1 To TGraphCollection.Count
    ...
    Private Sub Chart55_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Chart55.Click
        Me.Chart55.Focus()
    End Sub
    Private Sub Chart56_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Chart56.Click
        Me.Chart56.Focus()
    End Sub
    Private Sub Chart57_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Chart57.Click
        Me.Chart57.Focus()
    End Sub
    Private Sub Chart58_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Chart58.Click
        Me.Chart58.Focus()
    End Sub
    Private Sub Chart59_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Chart59.Click
        Me.Chart59.Focus()
    End Sub
    Private Sub Chart60_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Chart60.Click
        Me.Chart60.Focus()
    End Sub
    Private Sub Chart61_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Chart61.Click
        Me.Chart61.Focus()
    End Sub
    Private Sub Chart62_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Chart62.Click
        Me.Chart62.Focus()
    End Sub
    Private Sub Chart63_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Chart63.Click
        Me.Chart63.Focus()
    End Sub
    ...
    Private Sub Chart48_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Chart48.KeyDown
        If e.KeyCode = Keys.Delete Then
            ResetGraph(TGraphCollection.Item(49))
        Else
            Me.ListBox1.SelectedIndex = 48
            Call ListBox1_KeyDown(sender, e)
        End If
    End Sub
    Private Sub Chart49_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Chart49.KeyDown
        If e.KeyCode = Keys.Delete Then
            ResetGraph(TGraphCollection.Item(50))
        Else
            Me.ListBox1.SelectedIndex = 49
            Call ListBox1_KeyDown(sender, e)
        End If
    End Sub
    Private Sub Chart50_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Chart50.KeyDown
        If e.KeyCode = Keys.Delete Then
            ResetGraph(TGraphCollection.Item(51))
        Else
            Me.ListBox1.SelectedIndex = 50
            Call ListBox1_KeyDown(sender, e)
        End If
    End Sub
    Private Sub Chart51_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Chart51.KeyDown
        If e.KeyCode = Keys.Delete Then
            ResetGraph(TGraphCollection.Item(52))
        Else
            Me.ListBox1.SelectedIndex = 51
            Call ListBox1_KeyDown(sender, e)
        End If
    End Sub
    Private Sub Chart52_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Chart52.KeyDown
        If e.KeyCode = Keys.Delete Then
            ResetGraph(TGraphCollection.Item(53))
        Else
            Me.ListBox1.SelectedIndex = 52
            Call ListBox1_KeyDown(sender, e)
        End If
    End Sub
    Private Sub Chart53_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Chart53.KeyDown
        If e.KeyCode = Keys.Delete Then
            ResetGraph(TGraphCollection.Item(54))
        Else
            Me.ListBox1.SelectedIndex = 53
            Call ListBox1_KeyDown(sender, e)
        End If
    End Sub
    Private Sub Chart54_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Chart54.KeyDown
        If e.KeyCode = Keys.Delete Then
            ResetGraph(TGraphCollection.Item(55))
        Else
            Me.ListBox1.SelectedIndex = 54
            Call ListBox1_KeyDown(sender, e)
        End If
    End Sub
    Private Sub Chart55_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Chart55.KeyDown
        If e.KeyCode = Keys.Delete Then
            ResetGraph(TGraphCollection.Item(56))
        Else
            Me.ListBox1.SelectedIndex = 55
            Call ListBox1_KeyDown(sender, e)
        End If
    End Sub
    Private Sub Chart56_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Chart56.KeyDown
        If e.KeyCode = Keys.Delete Then
            ResetGraph(TGraphCollection.Item(57))
        Else
            Me.ListBox1.SelectedIndex = 56
            Call ListBox1_KeyDown(sender, e)
        End If
    End Sub
    Private Sub Chart57_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Chart57.KeyDown
        If e.KeyCode = Keys.Delete Then
            ResetGraph(TGraphCollection.Item(58))
        Else
            Me.ListBox1.SelectedIndex = 57
            Call ListBox1_KeyDown(sender, e)
        End If
    End Sub
    Private Sub Chart58_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Chart58.KeyDown
        If e.KeyCode = Keys.Delete Then
            ResetGraph(TGraphCollection.Item(59))
        Else
            Me.ListBox1.SelectedIndex = 58
            Call ListBox1_KeyDown(sender, e)
        End If
    End Sub
    Private Sub Chart59_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Chart59.KeyDown
        If e.KeyCode = Keys.Delete Then
            ResetGraph(TGraphCollection.Item(60))
        Else
            Me.ListBox1.SelectedIndex = 59
            Call ListBox1_KeyDown(sender, e)
        End If
    End Sub
    Private Sub Chart60_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Chart60.KeyDown
        If e.KeyCode = Keys.Delete Then
            ResetGraph(TGraphCollection.Item(61))
        Else
            Me.ListBox1.SelectedIndex = 60
            Call ListBox1_KeyDown(sender, e)
        End If
    End Sub
    Private Sub Chart61_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Chart61.KeyDown
        If e.KeyCode = Keys.Delete Then
            ResetGraph(TGraphCollection.Item(62))
        Else
            Me.ListBox1.SelectedIndex = 61
            Call ListBox1_KeyDown(sender, e)
        End If
    End Sub
    Private Sub Chart62_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Chart62.KeyDown
        If e.KeyCode = Keys.Delete Then
            ResetGraph(TGraphCollection.Item(63))
        Else
            Me.ListBox1.SelectedIndex = 62
            Call ListBox1_KeyDown(sender, e)
        End If
    End Sub
    Private Sub Chart63_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Chart63.KeyDown
        If e.KeyCode = Keys.Delete Then
            ResetGraph(TGraphCollection.Item(64))
        Else
            Me.ListBox1.SelectedIndex = 63
            Call ListBox1_KeyDown(sender, e)
        End If
    End Sub
    ...
    Private Sub InjuryChart_CopyEventEnd_Primary(ByRef MoveChart As Chart, ByRef TChart As Chart)
        ...
        With Me
            ...
            For i = 0 To MoveChart.Series.Count - 1
                ...
                Catch ex As Exception
                    Titles = GraphTitle_THOR(32) & " / " & MoveChart.Series(i).Name
                End Try
